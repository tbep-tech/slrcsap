...
This outlines how to propose a change to slrcsap. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("tbep-tech/slrcsap", fork = TRUE)`.
...
Code of
Conduct](https://github.com/tbep-tech/slrcsap/CODE_OF_CONDUCT.md). By
