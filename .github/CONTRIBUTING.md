# Contributing to slrcsap

This outlines how to propose a change to slrcsap.
...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("tbep-tech/slrcsap", fork = TRUE)`.
...
Please note that the slrcsap project is released with a
